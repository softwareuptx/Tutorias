            ...
            <div class="topbar">
              ...
              <div class="topbar-left">
                <div class="text-center">
                  <center>
                    <a href="<?=base_url()?>" class="logo"><i class="icon-c-logo"><img src="<?=images('uptx_escudo.png')?>"></i><span><img src="<?=images('logo_tutorias_blanco.png')?>" style="max-width:80%"></span></a>
                  </center>
                </div>
              </div>
        ...
        <li class="dropdown">
          <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="false"><img src="<?=base_url('docente/imagen')?>" alt="user-img" class="img-circle"></a>
