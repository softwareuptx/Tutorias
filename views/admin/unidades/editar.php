            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <!-- Formulario -->
                            <?=form_open('unidades/editar/'.$unidad->uni_id)?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" data-live-search="true"  id="institucion" name="institucion" data-style="btn-white">
                                            ...
                                            foreach ($instituciones as $key => $institucion){
                                                echo '<option value="'.$institucion->in_id.'" '.set_select('institucion', $institucion->in_id,FALSE,$unidad->uni_institucion).'>'.$institucion->in_nombre.'</option>';
                                            }
                                            ?>
                                        </select>
